...
{
    [Keyless]
    public partial class HrFixingEmployeeSalaryVw
    {
        [Column("ID")]
        ...
        [Column("Fixing_Type_Name")]
        [StringLength(250)]
        public string? FixingTypeName { get; set; }
        [Column("The_Fixing_SentTo_Name")]
        [StringLength(250)]
        public string? TheFixingSentToName { get; set; }
        [Column("Status_Name")]
        [StringLength(250)]
        ...
        public long? Expr7 { get; set; }
        public long? Expr8 { get; set; }
    }
}
