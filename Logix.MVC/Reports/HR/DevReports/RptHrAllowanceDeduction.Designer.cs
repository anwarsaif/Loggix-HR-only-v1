...
{
	partial class RptHrAllowanceDeduction
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HrAllowanceDeductionDS);
			...
			this.xrPanel1.SizeF = new System.Drawing.SizeF(1075F, 100F);
			// 
			// xrTable3
			// 
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(706.8334F, 10F);
            ...
            this.xrTable2});
			this.Detail1.HeightF = 40.83333F;
            ...
            this.xrTableRow2});
			this.xrTable2.SizeF = new System.Drawing.SizeF(1075F, 40.83333F);
			...
			this.xrTableCell12.Weight = 0.41085272500681325D;
			// 
			// xrTableCell13
			// 
			...
			this.xrTableCell13.Weight = 0.72868244259856463D;
			// 
			// xrTableCell14
			// 
			...
			this.xrTableCell14.Weight = 1.860464832394622D;
			// 
			// xrTableCell15
			// 
			...
			this.xrTableCell19.Weight = 1.271318586482558D;
			// 
			// xrTableCell20
			// 
			...
			this.xrTableCell20.Weight = 0.72868141351744187D;
			// 
			// xrTableCell21
			// 
			...
			this.xrTableCell21.Weight = 0.844961051053779D;
			// 
			// xrTableCell22
			// 
			...
			this.xrTableCell22.Weight = 1.1550389489462209D;
			// 
			// GroupHeader1
			// 
			this.GroupHeader1.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            this.xrTable1});
			this.GroupHeader1.HeightF = 61.66666F;
            ...
            | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 21.66667F);
			this.xrTable1.Name = "xrTable1";
			this.xrTable1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96F);
			this.xrTable1.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(1075F, 40F);
			...
			this.xrTableCell7.Weight = 0.41085272500681325D;
			// 
			// xrTableCell6
			// 
			this.xrTableCell6.Multiline = true;
			this.xrTableCell6.Name = "xrTableCell6";
			this.xrTableCell6.Text = "Employee Number";
			this.xrTableCell6.Weight = 0.72868230065634088D;
			// 
			// xrTableCell5
			// 
			...
			this.xrTableCell5.Weight = 1.8604649743368458D;
			// 
			// xrTableCell4
			// 
			this.xrTableCell4.Multiline = true;
			this.xrTableCell4.Name = "xrTableCell4";
			this.xrTableCell4.Text = "The branch";
			...
			this.xrTableCell2.Text = "Location";
			...
			this.xrTableCell3.Weight = 1.271318586482558D;
			// 
			// xrTableCell8
			// 
			this.xrTableCell8.Multiline = true;
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.Text = "The amount";
			this.xrTableCell8.Weight = 0.72868141351744187D;
			// 
			// xrTableCell10
			// 
			this.xrTableCell10.Multiline = true;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "The type";
			this.xrTableCell10.Weight = 0.844961051053779D;
			// 
			// xrTableCell11
			// 
			this.xrTableCell11.Multiline = true;
			this.xrTableCell11.Name = "xrTableCell11";
			this.xrTableCell11.Text = "Notes";
			this.xrTableCell11.Weight = 1.1550389489462209D;
			// 
			// PageFooter
			// 
            ...
            this.xrTableRow4});
			this.xrTable4.SizeF = new System.Drawing.SizeF(1075F, 30.83333F);
			...
			this.xrTableCell33.Text = " Created By  :";
			...
			this.xrTableCell36.Text = "Created On :";
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(14F, 11F, 20F, 100F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "22.2";
