...
{
  partial class HRProvisionsAllReport
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HRProvisionsEmployeeDS);
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(690.8334F, 15F);
            ...
            this.xrTableRow2});
			this.xrTable2.SizeF = new System.Drawing.SizeF(1045F, 36.66667F);
			...
			this.xrTableCell13.Weight = 0.83989763214082014D;
			// 
			// xrTableCell14
			// 
			...
			this.xrTableCell14.Weight = 1.2913865614695341D;
			// 
			// xrTableCell15
			// 
			...
			this.xrTableCell15.Weight = 1.1809154676885019D;
			// 
			// xrTableCell17
			// 
			...
			this.xrTableCell17.Weight = 1.3842458440980354D;
			// 
			// xrTableCell18
			// 
			...
			this.xrTableCell18.Weight = 0.95997455461339D;
			// 
			// xrTableCell19
			// 
			this.xrTableCell19.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[TotalAllowances]")});
			this.xrTableCell19.Multiline = true;
			this.xrTableCell19.Name = "xrTableCell19";
			this.xrTableCell19.Text = "xrTableCell8";
			this.xrTableCell19.Weight = 0.88952609744779676D;
			// 
			// xrTableCell20
			// 
			...
			this.xrTableCell20.Weight = 0.90652343499608867D;
			// 
			// xrTableCell21
			// 
			...
			this.xrTableCell21.Weight = 0.96600820353998862D;
			// 
			// xrTableCell22
			// 
			...
			this.xrTableCell22.Weight = 0.89802445501798878D;
			// 
			// xrTableCell12
			// 
			...
			this.xrTableCell12.Weight = 1.3399178089981372D;
			// 
			// GroupHeader1
			// 
            ...
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(1045F, 29.16667F);
			...
			this.xrTableCell6.Text = "رقم الموظف";
			this.xrTableCell6.Weight = 0.83989763214082014D;
			// 
			// xrTableCell5
			// 
			...
			this.xrTableCell5.Weight = 1.2913865614695341D;
			// 
			// xrTableCell4
			// 
			this.xrTableCell4.Multiline = true;
			this.xrTableCell4.Name = "xrTableCell4";
			this.xrTableCell4.Text = "الاداره/القسم";
			this.xrTableCell4.Weight = 1.1809154676885019D;
			// 
			// xrTableCell1
			// 
			this.xrTableCell1.Multiline = true;
			this.xrTableCell1.Name = "xrTableCell1";
			this.xrTableCell1.Text = "الموقع/المشروع";
			this.xrTableCell1.Weight = 1.3842458440980354D;
			// 
			// xrTableCell2
			// 
			this.xrTableCell2.Multiline = true;
			this.xrTableCell2.Name = "xrTableCell2";
			this.xrTableCell2.Text = "الراتب الاساسي";
			this.xrTableCell2.Weight = 0.95997455461339D;
			// 
			// xrTableCell8
			// 
			this.xrTableCell8.Multiline = true;
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.Text = "البدلات";
			this.xrTableCell8.Weight = 0.88952609744779676D;
			// 
			// xrTableCell3
			// 
			...
			this.xrTableCell3.Weight = 0.90652343499608867D;
			// 
			// xrTableCell10
			// 
			this.xrTableCell10.Multiline = true;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "المجموع";
			this.xrTableCell10.Weight = 0.96600820353998862D;
			// 
			// xrTableCell11
			// 
			...
			this.xrTableCell11.Weight = 0.89802445501798878D;
			// 
			// xrTableCell7
			// 
			this.xrTableCell7.Multiline = true;
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.Text = "المخصص";
			this.xrTableCell7.Weight = 1.3399178089981372D;
			// 
			// PageFooter
			// 
            ...
            this.xrTableRow4});
			this.xrTable4.SizeF = new System.Drawing.SizeF(1045F, 30.83333F);
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(27F, 28F, 15F, 100F);
            // Replace this line:
