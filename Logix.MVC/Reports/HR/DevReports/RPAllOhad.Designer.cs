namespace Logix.MVC.Reports.HR.DevReports
{
  partial class RPAllOhad
  {
    ...
    private void InitializeComponent()
    {
			...
			this.xrPictureBox1.SizeF = new System.Drawing.SizeF(306.8334F, 85F);
            ...
            this.xrTableRow4});
			this.xrTable4.SizeF = new System.Drawing.SizeF(1016F, 30.83333F);
			...
			this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(2.543131E-05F, 10.83333F);
			this.xrTable1.Name = "xrTable1";
            // Fix for CS1503 errors: PaddingInfo expects int parameters for left, right, top, bottom, and float for dpi.
			...
			this.xrTableCell1.Weight = 0.53494082683297872D;
			// 
			// xrTableCell2
			// 
			...
			this.xrTableCell2.Weight = 1.4650591731670213D;
			// 
			// xrTableCell3
			// 
			this.xrTableCell3.Multiline = true;
			this.xrTableCell3.Name = "xrTableCell3";
			this.xrTableCell3.Text = "تاريخ استلام العهده";
			...
			this.xrTableCell4.Weight = 0.53494082683297872D;
			// 
			// xrTableCell5
			// 
			...
			this.xrTableCell5.Weight = 1.4650591731670213D;
			// 
			// xrTableCell6
			// 
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(42F, 42F, 30.83333F, 100F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "25.1";
