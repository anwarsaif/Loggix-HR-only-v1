...
{
  partial class RptHrEmployeeFile
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HrEmployeeFileDS);
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(740.5F, 10F);
			this.xrPictureBox1.Name = "xrPictureBox1";
			this.xrPictureBox1.SizeF = new System.Drawing.SizeF(310.1667F, 85F);
            ...
            this.xrTableRow4});
			this.xrTable4.SizeF = new System.Drawing.SizeF(1074F, 30.83333F);
			...
			this.xrTableCell3.Text = "انتهاء العقد";
			...
			this.xrTableCell5.Weight = 1.248292891006896D;
			// 
			// xrTableCell6
			// 
			...
			this.xrTableCell6.Weight = 1.4577903108223855D;
			// 
			// xrTableCell7
			// 
			...
			this.xrTableCell7.Weight = 0.86809430397644616D;
			// 
			// xrTableCell8
			// 
			...
			this.xrTableCell8.Weight = 0.42582249419427232D;
			// 
			// xrTableCell10
			// 
			this.xrTableCell10.Multiline = true;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "حالة الموظف";
			...
			this.xrTableCell11.Text = "رقم الهوية";
			...
			this.xrTableCell12.Weight = 0.42582249419427232D;
			// 
			// xrTableCell13
			// 
			...
			this.xrTableCell13.Weight = 0.86809430397644616D;
			// 
			// xrTableCell14
			// 
			...
			this.xrTableCell14.Weight = 1.4577903108223855D;
			// 
			// xrTableCell15
			// 
			...
			this.xrTableCell15.Weight = 1.248292891006896D;
			// 
			// xrTableCell17
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Endofcontract]")});
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(12F, 13F, 14.16667F, 100F);
