...
{
	partial class RptHRPayrollQuery
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
            ...
            this.xrTable5,
            this.xrPictureBox1});
			this.xrPanel1.LocationFloat = new DevExpress.Utils.PointFloat(1.271566E-05F, 0F);
			this.xrPanel1.Name = "xrPanel1";
			this.xrPanel1.SizeF = new System.Drawing.SizeF(1096F, 100F);
			// 
			// xrTable3
			// 
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(730.8333F, 10F);
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HRPayrollQueryDS);
            ...
            this.xrTable2});
			this.Detail1.HeightF = 41.66667F;
            ...
            this.xrTableRow2});
			this.xrTable2.SizeF = new System.Drawing.SizeF(1096F, 41.66667F);
			...
			this.xrTableCell13.Weight = 0.46776154093498734D;
			// 
			// xrTableCell14
			// 
			...
			this.xrTableCell14.Weight = 1.5322384590650127D;
			// 
			// xrTableCell15
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[FinancelYear]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[MsMonth]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[HOverTime]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[CntAbsence]")});
            ...
            | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 18.33333F);
			this.xrTable1.Name = "xrTable1";
			this.xrTable1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96F);
			this.xrTable1.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(1096F, 37.5F);
			...
			this.xrTableCell8.Text = "رقم الموظف";
			this.xrTableCell8.Weight = 0.46776154093498734D;
			// 
			// xrTableCell7
			// 
			this.xrTableCell7.Multiline = true;
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.Text = "اسم الموظف";
			this.xrTableCell7.Weight = 1.5322384590650127D;
			// 
			// xrTableCell6
			// 
			this.xrTableCell6.Multiline = true;
			this.xrTableCell6.Name = "xrTableCell6";
			this.xrTableCell6.Text = "الاداره/القسم";
			...
			this.xrTableCell5.Text = "السنة المالية";
			...
			this.xrTableCell10.Text = "الوقت الاضافي";
			...
			this.xrTableCell3.Text = "الحسميات";
			...
			this.xrTableCell11.Text = "حسم الغياب";
			...
			this.xrTableCell12.Text = "حسم التاخير";
			...
			this.xrTableCell25.Text = "حسم السلف";
			...
			this.xrTableCell31.Text = "الحضور";
			...
			this.xrTableCell26.Text = "الجزاءات";
			...
			this.xrTableCell27.Text = "الصافي المستحق";
			...
			// objectDataSource2
			// 
			this.objectDataSource2.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HRPayrollQueryDS);
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(1F, 3F, 15F, 100F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "22.2";
