...
{
	partial class RptCompareByBranch
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HrCompareByBranchDS);
			...
			this.xrPanel1.SizeF = new System.Drawing.SizeF(1095F, 100F);
			// 
			// xrTable3
			// 
			this.xrTable3.LocationFloat = new DevExpress.Utils.PointFloat(445.9332F, 42.5F);
			...
			this.xrTable5.LocationFloat = new DevExpress.Utils.PointFloat(6F, 10F);
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(731.3334F, 10F);
			this.xrPictureBox1.Name = "xrPictureBox1";
			this.xrPictureBox1.SizeF = new System.Drawing.SizeF(340.1667F, 85F);
            ...
            this.xrTableRow2});
			this.xrTable2.SizeF = new System.Drawing.SizeF(1095F, 45F);
			...
			this.xrTableCell13.Weight = 0.44849595927280816D;
			// 
			// xrTableCell14
			// 
			...
			this.xrTableCell14.Weight = 1.5515040407271918D;
			// 
			// xrTableCell15
			// 
			...
			this.xrTableCell15.Text = "عدد الموظفيين";
			...
			this.xrTableCell18.Text = "البدلات";
			...
			this.xrTableCell24.Text = "الوقت الاضافي ";
			...
			this.xrTableCell25.Text = "المكافات";
			...
			this.xrTableCell26.Text = "الاجمالي";
			...
			this.xrTableCell28.Text = "حسميات اخرى";
			...
			this.xrTableCell29.Text = "الصافي";
			...
			this.xrTableCell20.Text = "[TotalNet]";
            ...
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(1097F, 38.33333F);
			...
			this.xrTableCell7.Weight = 0.44849595927280816D;
			// 
			// xrTableCell6
			// 
			...
			this.xrTableCell6.Weight = 1.5515040407271918D;
			// 
			// xrTableCell5
			// 
			this.xrTableCell5.Multiline = true;
			this.xrTableCell5.Name = "xrTableCell5";
			this.xrTableCell5.Text = "الشهر";
			...
			this.xrTableCell4.Text = "عدد الموظفيين";
			...
			this.xrTableCell1.Text = "الراتب الاساسي";
			...
			this.xrTableCell2.Text = "البدلات";
			...
			this.xrTableCell3.Text = "الوقت الاضافي ";
			...
			this.xrTableCell8.Text = "المكافات";
			...
			this.xrTableCell12.Text = "حسميات اخرى";
			...
			this.xrTable4.LocationFloat = new DevExpress.Utils.PointFloat(0F, 9.166666F);
			this.xrTable4.Name = "xrTable4";
			this.xrTable4.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96F);
			this.xrTable4.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow4});
			this.xrTable4.SizeF = new System.Drawing.SizeF(1096F, 30.83333F);
			...
			this.xrTableCell37.TextFormatString = "{0:yyyy/MM/dd hh:mm:ss tt}";
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(2F, 3F, 10F, 21.66667F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "22.2";
