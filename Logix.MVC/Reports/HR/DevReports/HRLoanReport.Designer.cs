namespace Logix.MVC.Reports.HR.DevReports
{
  partial class HRLoanReport
  {
    ...
    private void InitializeComponent()
    {
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HRLoanReportDS);
			...
			// xrTable3
			// 
			this.xrTable3.LocationFloat = new DevExpress.Utils.PointFloat(414.1668F, 39.16667F);
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(690.8333F, 15F);
			this.xrPictureBox1.Name = "xrPictureBox1";
			this.xrPictureBox1.SizeF = new System.Drawing.SizeF(358.1667F, 85F);
            ...
            this.xrTable1});
			this.GroupHeader1.HeightF = 57.5F;
			...
			this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 32.5F);
			this.xrTable1.Name = "xrTable1";
			this.xrTable1.Padding = new DevExpress.XtraPrinting.PaddingInfo((int)2F, (int)2F, (int)0F, (int)0F, 96F);
			...
			this.xrTableCell8.Text = "الرقم";
			this.xrTableCell8.Weight = 0.55414014127278344D;
			// 
			// xrTableCell7
			// 
			this.xrTableCell7.Multiline = true;
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.Text = "رقم الموظف";
			this.xrTableCell7.Weight = 0.7998176970408114D;
			// 
			// xrTableCell6
			// 
			this.xrTableCell6.Multiline = true;
			this.xrTableCell6.Name = "xrTableCell6";
			this.xrTableCell6.Text = "اسم الموظف";
			this.xrTableCell6.Weight = 1.6460421616864054D;
			// 
			// xrTableCell2
			// 
			this.xrTableCell2.Multiline = true;
			this.xrTableCell2.Name = "xrTableCell2";
			this.xrTableCell2.Text = "تاريخ السلفة";
			this.xrTableCell2.Weight = 1.2547765979992465D;
			// 
			// xrTableCell3
			// 
			...
			this.xrTableCell3.Weight = 0.97270287330634386D;
			// 
			// xrTableCell10
			// 
			this.xrTableCell10.Multiline = true;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "القسط";
			this.xrTableCell10.Weight = 0.77252052869440968D;
			// 
			// xrTableCell11
			// 
			this.xrTableCell11.Multiline = true;
			this.xrTableCell11.Name = "xrTableCell11";
			this.xrTableCell11.Text = "الاشهر";
			this.xrTableCell11.Weight = 0.66333143878134948D;
			// 
			// xrTableCell12
			// 
			this.xrTableCell12.Multiline = true;
			this.xrTableCell12.Name = "xrTableCell12";
			this.xrTableCell12.Text = "تاريخ البداية";
			this.xrTableCell12.Weight = 1.2001808451131002D;
			// 
			// xrTableCell25
			// 
			this.xrTableCell25.Multiline = true;
			this.xrTableCell25.Name = "xrTableCell25";
			this.xrTableCell25.Text = "تاريخ النهاية";
			this.xrTableCell25.Weight = 1.1364877161055504D;
			// 
			// xrTable2
			// 
			...
			this.xrTable2.Padding = new DevExpress.XtraPrinting.PaddingInfo((int)2F, (int)2F, (int)0F, (int)0F, 96F);
			...
			this.xrTableCell13.Weight = 0.55414009962003807D;
			// 
			// xrTableCell14
			// 
			...
			this.xrTableCell14.Weight = 0.799817988610029D;
			// 
			// xrTableCell15
			// 
			...
			this.xrTableCell15.Weight = 1.646041911769933D;
			// 
			// xrTableCell20
			// 
			...
			this.xrTableCell20.Weight = 1.2547765979992465D;
			// 
			// xrTableCell21
			// 
			...
			this.xrTableCell21.Weight = 0.97270287330634386D;
			// 
			// xrTableCell22
			// 
			...
			this.xrTableCell22.Weight = 0.77252052869440968D;
			// 
			// xrTableCell23
			// 
			...
			this.xrTableCell23.Weight = 0.66333277166920213D;
			// 
			// xrTableCell24
			// 
			...
			this.xrTableCell24.Weight = 1.2001795122252474D;
			// 
			// xrTableCell26
			// 
			...
			this.xrTableCell26.Weight = 1.1364877161055504D;
			// 
			// PageFooter
			// 
            ...
            this.xrTableRow4});
			this.xrTable4.SizeF = new System.Drawing.SizeF(1059F, 30.83333F);
			...
			this.xrTableCell1.Weight = 1.1364877161055504D;
			// 
			// xrTableCell4
			// 
			this.xrTableCell4.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RemainingAmount]")});
			this.xrTableCell4.Multiline = true;
			this.xrTableCell4.Name = "xrTableCell4";
			this.xrTableCell4.Text = "xrTableCell4";
			this.xrTableCell4.Weight = 1.1364877161055504D;
			// 
			// HRLoanReport
			// 
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(22F, 19F, 17.5F, 100F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "25.1";
