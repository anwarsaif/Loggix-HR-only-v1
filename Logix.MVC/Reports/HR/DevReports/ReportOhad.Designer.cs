namespace Logix.MVC.Reports.HR.DevReports
{
  partial class ReportOhad
  {
    ...
    private void InitializeComponent()
    {
			...
			// topMarginBand1
			// 
			this.topMarginBand1.HeightF = 19.16667F;
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.ReportOhadDS);
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(699.8333F, 15F);
            ...
            this.xrTable2});
			this.detailBand2.HeightF = 35.83333F;
            ...
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(1050F, 26.66667F);
			...
			this.xrTableCell1.Weight = 1.5396823846726191D;
			// 
			// xrTableCell2
			// 
			...
			this.xrTableCell2.Weight = 0.58730189732142857D;
			// 
			// xrTableCell3
			// 
			...
			this.xrTableCell3.Weight = 1.1142861793154764D;
			// 
			// xrTableCell4
			// 
			...
			this.xrTableCell4.Weight = 0.68888881138392855D;
			// 
			// xrTableCell5
			// 
			this.xrTableCell5.Multiline = true;
			this.xrTableCell5.Name = "xrTableCell5";
			this.xrTableCell5.Text = "تاريخ العهده";
			this.xrTableCell5.Weight = 0.9428572591145834D;
			// 
			// xrTableCell6
			// 
			this.xrTableCell6.Multiline = true;
			this.xrTableCell6.Name = "xrTableCell6";
			this.xrTableCell6.Text = "رقم العهده";
			this.xrTableCell6.Weight = 0.66984119233630945D;
			// 
			// xrTableCell7
			// 
			this.xrTableCell7.Multiline = true;
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.Text = "الحالة";
			this.xrTableCell7.Weight = 0.90476143973214285D;
			// 
			// xrTableCell8
			// 
			...
			this.xrTableCell8.Weight = 1.5523808361235119D;
			// 
			// xrTable2
			// 
            ...
            this.xrTableRow2});
			this.xrTable2.SizeF = new System.Drawing.SizeF(1050F, 35.83333F);
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[OhadId]")});
			this.xrTableCell10.Multiline = true;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "xrTableCell6";
			this.xrTableCell10.Weight = 0.66984119233630945D;
			// 
			// xrTableCell11
			// 
			this.xrTableCell11.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[OhdaDate]")});
			this.xrTableCell11.Multiline = true;
			this.xrTableCell11.Name = "xrTableCell11";
			this.xrTableCell11.Text = "xrTableCell5";
			this.xrTableCell11.Weight = 0.9428572591145834D;
			// 
			// xrTableCell12
			// 
			...
			this.xrTableCell12.Weight = 0.68888881138392855D;
			// 
			// xrTableCell13
			// 
			...
			this.xrTableCell13.Weight = 1.5396823846726191D;
			// 
			// xrTableCell14
			// 
			...
			this.xrTableCell14.Weight = 0.58730189732142857D;
			// 
			// xrTableCell15
			// 
			...
			this.xrTableCell15.Weight = 1.1142861793154764D;
			// 
			// xrTableCell17
			// 
			...
			this.xrTableCell17.Weight = 0.90476143973214285D;
			// 
			// xrTableCell18
			// 
			...
			this.xrTableCell18.Weight = 1.5523808361235119D;
			// 
			// PageFooter
			// 
            ...
            this.xrTableRow4});
			this.xrTable4.SizeF = new System.Drawing.SizeF(1050F, 30.83333F);
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(26F, 24F, 19.16667F, 100F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "25.1";
