namespace Logix.MVC.Reports.HR.DevReports
{
	partial class RptCurrBalance
	{
		...
		private void InitializeComponent()
		{
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HrCurrBalanceDS);
			...
			// xrTable3
			// 
			this.xrTable3.LocationFloat = new DevExpress.Utils.PointFloat(367.1668F, 39.16667F);
            ...
            this.xrTableRow6});
			this.xrTable5.SizeF = new System.Drawing.SizeF(266.6666F, 42.5F);
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(721.8333F, 10F);
            ...
            this.xrTable2});
			this.Detail1.HeightF = 34.16667F;
            ...
            this.xrTable1});
			this.GroupHeader1.HeightF = 44.16667F;
			...
			this.xrTableCell23.Text = "تم الانشاء بواسطة  :";
			...
			this.xrTableCell20.Text = "تم الانشاء في :";
			...
			this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(6.357829E-06F, 10F);
			this.xrTable1.Name = "xrTable1";
			this.xrTable1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96F);
			this.xrTable1.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(1062F, 34.16667F);
			...
			this.xrTableCell1.Text = "تاريخ بداية الاحتساب";
			...
			this.xrTableCell2.Text = "الرصيد من تاريخ الاحتساب";
			...
			this.xrTableCell3.Text = "الرصيد المستحق الكلي";
			...
			this.xrTableCell4.Text = "الرصيد المستخدم";
			...
			this.xrTableCell5.Text = "الرصيد الافتتاحي";
			...
			this.xrTableCell6.Weight = 1.3790019770910089D;
			// 
			// xrTableCell7
			// 
			...
			this.xrTableCell7.Weight = 0.62099802290899109D;
			// 
			// xrTable2
			// 
            ...
            | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.xrTable2.LocationFloat = new DevExpress.Utils.PointFloat(6.357829E-06F, 0F);
			this.xrTable2.Name = "xrTable2";
			this.xrTable2.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96F);
			this.xrTable2.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow2});
			this.xrTable2.SizeF = new System.Drawing.SizeF(1062F, 34.16667F);
			...
			this.xrTableCell8.Weight = 0.620997972621074D;
			// 
			// xrTableCell10
			// 
			...
			this.xrTableCell10.Weight = 1.3790020273789261D;
			// 
			// xrTableCell11
			// 
			this.xrTableCell11.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[OpBalance]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[BalanceUsed]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[CurrDate]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[CurBalance]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[BalanceInYear]")});
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(18F, 20F, 22.5F, 100F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "22.2";
