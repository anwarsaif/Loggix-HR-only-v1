...
{
	partial class RptPayrollByLocation
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(global::Logix.MVC.Reports.HR.ViewModels.HrPayrollByLocationDS);
			...
			this.xrPanel1.SizeF = new System.Drawing.SizeF(1096F, 97.5F);
			// 
			// xrPictureBox1
			// 
			...
			this.xrPictureBox1.LocationFloat = new DevExpress.Utils.PointFloat(709.8333F, 12.5F);
			...
			// xrTable3
			// 
			this.xrTable3.LocationFloat = new DevExpress.Utils.PointFloat(413.3334F, 38.33333F);
            ...
            this.xrTableRow2});
			this.xrTable2.SizeF = new System.Drawing.SizeF(1096F, 45F);
			...
			this.xrTableCell17.Text = "الراتب الاساسي";
			...
			this.xrTableCell19.Text = "الوقت الاضافي ";
			...
			this.xrTableCell20.Text = "المكافات";
			...
			this.xrTableCell23.Text = "حسميات اخرى";
			...
			this.xrTableCell24.Text = "الصافي";
			...
			this.xrTableCell6.Text = "الموقع/المشروع";
			...
			this.xrTableCell5.Text = "عدد الموظفيين";
			...
			this.xrTableCell4.Text = "الراتب الاساسي";
			...
			this.xrTableCell1.Text = "البدلات";
			...
			this.xrTableCell2.Text = "الوقت الاضافي ";
			...
			this.xrTableCell3.Text = "المكافات";
			...
			this.xrTableCell11.Text = "حسميات اخرى";
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(2F, 2F, 15.83333F, 100F);
			this.PageHeight = 850;
			this.PageWidth = 1100;
			this.Version = "22.2";
